...
public class ApiException extends RuntimeException {
    ...
    public static final ApiException USER_ALREADY_LIKED_COMMENT = new ApiException("User already liked this comment", 1406, HttpStatus.BAD_REQUEST);
    public static final ApiException USER_DID_NOT_LIKED_COMMENT = new ApiException("User did not like this comment", 1407, HttpStatus.BAD_REQUEST);
